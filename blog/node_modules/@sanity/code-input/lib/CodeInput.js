...
var CodeInput = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  var handleToggleSelectLine = (0, _react.useCallback)(lineNumber => {
    ...
    onChange(_PatchEvent.default.from((0, _PatchEvent.set)(currentHighlightedLines.map(line =>
  ...
  var renderEditor = (0, _react.useCallback)(() => {
    ...
    var language = (value === null || value === void 0 ? void 0 : value.language) || fixedLanguage;

    // the language config from the schema
    var configured = languages.find(entry => entry.value === language);

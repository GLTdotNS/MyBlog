...
async function initSanity(args, context) {
  ...
  if (reconfigure) {
    ...
    try {
      const coreModule = corePath && (0, _dynamicRequire.default)(corePath);
      coreCommands = coreModule && coreModule.commands;
    } catch (err) {
      (0, _debug.default)(`Failed to require '@sanity/core': ${err instanceof Error ? err.message : err}`);
    }
    ...
    if (Array.isArray(coreCommands)) {
      ...
      (0, _debug.default)('Skipping configcheck since `@sanity/core` could not be found');
